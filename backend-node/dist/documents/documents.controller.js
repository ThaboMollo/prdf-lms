...
let DocumentsController = class DocumentsController {
    ...
    list(u) { return this.svc.listRequirements(u); }
    create(u, body) { return this.svc.createRequirement(u, body); }
    async verify(u, appId, docId, body) {
...
__decorate([
    (0, common_1.Post)('applications/:appId/documents/:docId/verify'),
