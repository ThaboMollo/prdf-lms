...
//
// This is the newer, more complete copy (previously client-ui only, including
// the Phahla-referral item); admin-ui's staff-assisted flow was on an older,
// shorter version (CONSENT_VERSION '2026-07-01', missing that item) — a real
